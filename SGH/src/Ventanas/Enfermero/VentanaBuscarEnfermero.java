...
public class VentanaBuscarEnfermero extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaBuscarEnfermero() {
        initComponents();
    }

    VentanaBuscarEnfermero(ActionEvent evt, Hospital hospi) {
            initComponents();
            setHospital(hospi);
    }
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        {
        vr = new VentanaReporte(evt,hospi,hospi.buscarEnfermeria(rut));
        botonBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    VentanaBuscarEnfermero.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBuscarEnfermero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBuscarEnfermero().setVisible(true);
            }
        });
    }

...
public class VentanaModificarEnfermero extends javax.swing.JFrame {
    ...
    VentanaModificarEnfermero(ActionEvent evt, Hospital hospi,String rutEnfermero) {
        initComponents();
        setHospital(hospi);
        setRutEnfermero(rutEnfermero);
    }
        ...
        botonVolver.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    VentanaModificarEnfermero.this.dispose();
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        String rut = rutEnfermero;
        String nombre = this.nombre.getText();
        String sexo = this.sexo.getText();
        if(hospi.modificarEnfermeria(nombre,rut,sexo)==true)
        {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VentanaModificarEnfermero().setVisible(true);
            }
        });
    }

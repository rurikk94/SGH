...
public class VentanaEliminarEnfermero extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaEliminarEnfermero() {
        initComponents();
    }

    VentanaEliminarEnfermero(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(botonEliminar, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)))
        );
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        if(hospi.eliminarEnfermeriaLista(rut)==true){
            VentanaSucess ok = new VentanaSucess(evt,hospi);
            ok.setVisible(true);
            ok.setLocationRelativeTo(null);
            VentanaEliminarEnfermero.this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarEnfermero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEliminarEnfermero().setVisible(true);
            }
        });
    }

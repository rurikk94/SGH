...
public class VentanaBuscarTens extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaBuscarTens() {
        initComponents();
    }

    VentanaBuscarTens(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        {
            vr = new VentanaReporte(evt,hospi,hospi.buscarTens(rut));
            botonBuscar.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        VentanaBuscarTens.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBuscarTens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBuscarTens().setVisible(true);
            }
        });
    }

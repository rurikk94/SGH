...
public class VentanaBuscarTensModificar extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaBuscarTensModificar() {
        initComponents();
    }

    VentanaBuscarTensModificar(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        final VentanaModificarTens vr ;
        if(hospi.buscarTens(rut)!=null)
        {
            vr = new VentanaModificarTens(evt,hospi,hospi.buscarTens(rut).getRut());
            botonBuscar.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        VentanaBuscarTensModificar.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBuscarTensModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBuscarTensModificar().setVisible(true);
            }
        });
    }

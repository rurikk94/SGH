...
public class VentanaAgregarTens extends javax.swing.JFrame {

    private Hospital hospi;
    private Secundaria sec;
    
    public VentanaAgregarTens() {
        initComponents();
        sec = new Secundaria();
    }

    VentanaAgregarTens(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
        sec = new Secundaria();
    }
        ...
        botonVolver.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    VentanaAgregarTens.this.dispose();
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        if(this.nombre.getText().equals("")==false)
        {
            ...
            if(sec.validarRut(this.run.getText())==true)
            {
                ...
                {
                    String sexualidad = this.sexo.getText();
                    if(hospi.agregarTensLista(nombre,rut,sexualidad)==true){
                ...
                {
                    JOptionPane.showMessageDialog(null, "El sexo ingresado es incorrecto");
            ...
            {
                JOptionPane.showMessageDialog(null, "El rut ingresado es incorrecto");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VentanaAgregarTens().setVisible(true);
            }
        });
    }

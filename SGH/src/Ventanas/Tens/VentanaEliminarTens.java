...
public class VentanaEliminarTens extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaEliminarTens() {
        initComponents();
    }

    VentanaEliminarTens(ActionEvent evt,Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarTens.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEliminarTens().setVisible(true);
            }
        });
    }

...
public class VentanaBuscarMedicoModificar extends javax.swing.JFrame {

    private Hospital hospi;
    
    public VentanaBuscarMedicoModificar() {
        initComponents();
    }

    VentanaBuscarMedicoModificar(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RUN del médico");
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        final VentanaModificarMedicos vr ;
        if(hospi.buscarMedico(rut)!=null)
        {
        vr = new VentanaModificarMedicos(evt,hospi,hospi.buscarMedico(rut).getRut());
        botonBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    VentanaBuscarMedicoModificar.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBuscarMedicoModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaBuscarMedicoModificar().setVisible(true);
            }
        });
    }

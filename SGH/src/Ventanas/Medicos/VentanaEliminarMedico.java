...
public class VentanaEliminarMedico extends javax.swing.JFrame {
    ...
    VentanaEliminarMedico(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaEliminarMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEliminarMedico().setVisible(true);
            }
        });
    }

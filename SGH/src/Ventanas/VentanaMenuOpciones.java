...
import Ventanas.Paciente.VentanaMenuPaciente;
...
public class VentanaMenuOpciones extends javax.swing.JFrame {
    ...
    public VentanaMenuOpciones() {
        initComponents();
    }
    
    public VentanaMenuOpciones(ActionEvent evt, Hospital hospi) {
        initComponents();
        setHospital(hospi);
    }
        ...
        botonFuncionario.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    VentanaMenuOpciones.this.dispose();
    ...
    private void botonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalirActionPerformed
        ...
        final VentanaPrincipal vr ;
        vr = new VentanaPrincipal(evt,hospi);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaMenuOpciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VentanaMenuOpciones().setVisible(true);
            }
        });
    }
